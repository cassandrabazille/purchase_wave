    ...
    <div class="container">
        ...
        <div class="padding-top-2">
            ...
            <div class="black-box-shadow border-radius-1">
                ...
                <h3 class="medium-grey-color font-weight-500 padding-left-2 padding-bottom-2">Liste de tous les utilisateurs
                    enregistrés</h3>
                                    ...
                                    <td class="text-align-left padding-1-6-2 with-bottom-border">
                                        ...
                                        <div class="align-items-center gap-1-5">
                                            ...
                                            <form action="{{ route('admin.destroy', $user->user_id) }}" method="POST"
                                                class="d-inline"
                                                onsubmit="return confirm ('Supprimer ce compte utilisateur ?');">
                                                @csrf
                                                @method('DELETE')
