            ...
            <div class="margin-top-4">
                ...
                <form method="POST" action="{{ route('admin.login.post') }}">
                    ...
                    <div class="responsive-confirm-btn">
                        <button type="submit"
                            class="responsive-button justify-center align-items-center blue-background width-22 height-6 border-radius-2-5 no-border font-poppins-ss font-size-1-4 white-color margin-bottom-5 hover-blue cursor-pointer">Connexion</button>
                    </div>
