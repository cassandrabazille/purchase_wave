...
@if ($errors->has('login'))
    <div class="light-red-background white-color margin-top-2 border-radius-1 padding-3 font-size-1-4 text-center margin-bottom-2">
        {{ $errors->first('login') }}
    </div>
@endif
    ...
    <main class="responsive-login flex-row gap-3 margin-top-2">
        ...
        <section class="margin-top-4">
            ...
            <form method="POST" action="{{ route('admin.login.post') }}">
                ...
                <button type="submit"
                    class="responsive-button justify-center align-items-center blue-background width-22 height-6 border-radius-2-5 no-border font-poppins-ss font-size-1-4 white-color margin-bottom-5 hover-blue cursor-pointer">Login</button>
            </div>
                </form>
        </section>
    </main>
