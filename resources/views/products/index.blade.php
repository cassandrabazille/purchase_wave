            ...
            <div class="black-box-shadow border-radius-1">
                ...
                <div class="justify-flex-end padding-3">
                    <a href={{route('products.create')}}>
                        <button
                            class="responsive-button black-background white-color font-poppins-ss font-size-1-4 align-items-center justify-center width-27 height-4-4 border-radius-1 black-box-shadow no-border cursor-pointer">Créer
                            un nouveau produit</button>
                    </a>
                </div>
                <h2 class="padding-2">Produits</h2>
                <h3 class="medium-grey-color font-weight-500 padding-left-2 padding-bottom-2">Liste de tous les produits enregistrés</h3>
                <div>
                    <table class="width-100pct font-size-1-6 border-collapse no-border">
                        <thead>
                            <tr class="grey-background">
                                ...
                                <th class="font-weight-bold text-align-left padding-1-6-2">Mots clés associés
                                </th>
                                <th class="hide-mobile font-weight-bold text-align-left padding-1-6-2">Date création</th>
                                        ...
                                        <div class="align-items-center gap-1-5">
                                            <form action="{{ route('products.show', $product->id) }}" method="GET"
                                                ...
                                                <button type="submit" style=" background: none; border: none"
                                                    ...
                                                    <img src="{{ asset('images/view.png') }}"
                                                        alt="Icône oeil pour voir le détail du produit" class="eye-icon" />
                                                </button>
                                            </form>
                                            <form action="{{ route('products.edit', $product->id) }}" method="GET"
                                                ...
                                                <button type="submit" style=" background: none; border: none"
                                                    ...
                                                    <img src="{{ asset('images/edit.png') }}"
                                                        alt="Icône crayon pour modifier le produit" class="pencil-icon"/>
                                                </button>
                                            </form>
                                            <form action="{{ route('products.destroy', $product) }}" method="POST"
                                                ...
                                                <button type="submit" class="cursor-pointer no-border no-background"><img
                                                        ...
                                                        alt="Icône croix pour supprimer le produit" class="width-2 height-2 delete-icon" />
                                                </button>
                                            </form>
                                        </div>
                                    </td>
