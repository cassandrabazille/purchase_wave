                ...
                <div class="flex-row justify-center">
                    <div
                        ...
                        <form action="{{ route('products.update', $product->id)}}" method="POST"
                            ...
                            @csrf
                            @method('PUT')
                            <label for="description" class="margin-bottom-2 display-block">Descriptif du produit :
                                <input type="text" id="description" name="description"
                                    value="{{ old('description', $product->description) }}">
                            </label>
                            <label for="price" class="margin-bottom-2 display-block">Prix du produit :
                            ...
                            <label for="image" class="margin-bottom-2">
                                <input type="file" id="image" name="image" class="margin-top-2"
