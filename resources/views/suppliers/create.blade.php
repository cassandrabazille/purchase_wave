    ...
    <main class="padding-top-2">
        <div">
            ...
            <div class="border-radius-1 black-box-shadow padding-3 max-width-70pct">
                <h2 class="padding-bottom-2">Création du fournisseur</h2>
                <form action="{{ route('suppliers.store') }}" method="POST">
                    @csrf
                    <p class="margin-bottom-2">Nom du fournisseur <input type="text" name="name"></p>
                    <p class="margin-bottom-2">Téléphone du fournisseur <input type="text" name="telephone"></p>
                    <p class="margin-bottom-2">Mail du fournisseur : <input type="text" name="email"></p>
                    <p class="margin-bottom-2">Adresse du fournisseur : <input type="text" name="address"></p>
                    </p>
