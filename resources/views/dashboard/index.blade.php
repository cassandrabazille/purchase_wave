...
<div class="dashboard-responsive flex-column padding-top-2 grey-background border-radius-1 margin-top-2 padding-top-2 padding-right-3-5 gap57 width-12 ">
            ...
            @forelse ($latestPendingOrders as $index => $order)
                <div class="order-{{ $index + 1 }}">
                    <a href="{{ route('orders.show', $order->id) }}" class="flex-row align-items-center gap-1">
                         <img src="{{ asset('images/view.png') }}" alt="Icône oeil pour aller voir le détail commande." class="reponsive-icon">
        ...
        <div class="responsive-data flex-column gap-1">
            ...
            <section class="flex-row gap-7 margin-left-4 margin-top-4 padding-bottom-4">
                ...
                <div class="white-background border-radius-1 height-32 width-38 font-size-1-4">
                    ...
                    <span class="display-block">{{ $statusCounts['en attente']}}
                        </span>
                    </p>
                    </div>
                    ...
                    <p>
                        <span>Expédiée :</span>
                    <span class="display-block">{{ $statusCounts['expédiée']}}</span>
                    </p>
                    </div>
                    ...
                    <p>
                     <span>Livrées : </span>   
                      <span class="display-block"> {{ $statusCounts['livrée']}}</span> 
                    </p>
                    </div>

                        <div class="border-radius-1 padding-1 black-background white-color">
                    <p>
                        <span>Annulées :</span>
                       <span class="display-block"> {{ $statusCounts['annulée']}}</span>
