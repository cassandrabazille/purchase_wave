...
<body>
    ...
    <header class="responsive-header flex-row space-between align-items-center padding-right-2 padding-left-2">
        ...
        <nav class="responsive-header gap-7 align-items-center">
            ...
            <div class="manage-reference font-weight-500 cursor-pointer no-user-select flex-column align-items-center" onclick="toggleReferencesDropdown()">
                <p class="dropdown-ref light-grey-background border-radius-0-4 padding-0-4-0-8">Gestion des références</p>
                 <ul id="referencesDropdownMenu" class="flex-column text-align-center white-background no-list-style with-grey-border" style="display: none;">
            <li class="no-list-style padding-bottom-6 padding-O-6-1-6"><a class="font-weight-500" href="{{ route('products.index') }}">Produits</a></li>
            <li class="no-list-style padding-bottom-6 padding-O-6-1-6"><a class="font-weight-500" href="{{ route('suppliers.index') }}">Fournisseurs</a></li>
            <li class="no-list-style padding-bottom-6 padding-O-6-1-6"><a class="font-weight-500" href="{{ route('categories.index') }}">Catégories</a></li>
            </ul>
            </div>

     <div class="flex-row align-items-center gap-2 cursor-pointer" onclick="toggleDropdown()">
    <img src="{{ asset('images/user-img.png') }}" alt="Image de profil de l'utilisateur.">
