                ...
                <div class="flex-row justify-center">
                    ...
                    <div class="border-radius-1 black-box-shadow padding-3 max-width-70pct">
                        ...
                        <form action="{{ route('categories.update', $category->id)}}" method="POST">
                            ...
                            <label for="name" class="margin-bottom-2 display-block">Nom de la catégoire :
                                <input type="text" id="name" name="name" value="{{ old('name', $category->name) }}"></label>

                            <label for="description" class="margin-bottom-2 display-block">Descriptif de la catégoire :
                                <input type="text" id="description" name="description"
                                    value="{{ old('description', $category->description) }}"></label>
