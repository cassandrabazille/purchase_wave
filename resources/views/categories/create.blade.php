        ...
        <main class="padding-top-2">
            ...
            <div class="border-radius-1 black-box-shadow padding-3 max-width-70pct">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        @csrf
                        <p class="margin-bottom-2">Nom de la catégorie : <input type="text" name="name"></p>
                        <p class="margin-bottom-2">Descriptif de la catégorie : <input type="text" name="description"></p>
