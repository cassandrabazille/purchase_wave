                ...
                <div class="flex-row justify-center">
                    ...
                    <div class="border-radius-1 black-box-shadow padding-3 max-width-70pct">
                        ...
                        <form action="{{ route('categories.store') }}" method="POST">
                            @csrf
                            <label for="name" class="margin-bottom-2 display-block">Nom de la catégorie :
                                <input type="text" id="name" name="name"></label>

                            <label for="description" class="margin-bottom-2 display-block">Descriptif de la catégorie :
