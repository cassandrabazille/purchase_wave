                        ...
                        <form action="{{ route('orders.update', $order->id)}}" method="POST">
                            ...
                            <p>Statut :
                                <select name="status"
                                    ...
                                    <option value="en attente" {{ old('status', $order->status) === 'en attente' ? 'selected' : '' }}>En attente
                                    </option>
                                    <option value="expédiée" {{ old('status', $order->status) === 'expédiée' ? 'selected' : '' }}>
                                        Expédiée</option>
                                    <option value="livrée" {{ old('status', $order->status) === 'livrée' ? 'selected' : '' }}>Livrée
                                    </option>
                            ...
                            <p class="margin-bottom-2">Date de livraison confirmée : <input type="date" name="confirmed_delivery_date"
